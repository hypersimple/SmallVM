...
def do_slicing(text,init_line_0,slice_set,instr_list,tmp2_dict,index_list,index):
    for subline in xrange(0,init_line_0 + 1):
        ...
        # XXX: set the cut line number
        if (init_line_0-subline) <= 14594558 - 1:
            break
...
SliceSource = "./qemu019_5/slicing_source_cut.txt"
...
i = 0
f2 = open("./qemu019_5/qemu019_5_slicing_cut.log","w")
...
i = 0
f2 = open("./qemu019_5/qemu019_5_slicing_cut_block.log","w")
