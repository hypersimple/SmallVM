...
def execute_all(trace_file,reg,tmp,mem,memmap_table,pre_calc_destfile):
    f = open(trace_file, "r")
    text = f.readlines()
    f.close()
    count = 0
...
trace_file = "qemu17_fetch_new.log"
pre_calc_destfile = "qemu17_instr_new.log"
#disk = 
#-----------------------------------------------------------------------------------------    
#Global declaration
...
execute_all(trace_file,reg,tmp,mem,memmap_table,pre_calc_destfile)
